...
export const themePalettes: Record<ThemeId, ThemeDefinition> = {
  system: {
    ...
    vars: {
      ...
      '--accent-light': '#548bf5',
      '--accent-dark': '#1f4bb6',
      '--accent-glow': 'rgba(44,107,237,0.30)',
      '--accent-glow-light': 'rgba(44,107,237,0.15)',
      '--text-main': '#f6f6f6',
      '--text-dim': '#848484',
      '--text-offline': '#5e5e5e',
      '--text-heading': '#ffffff',
      '--surface-container': '#2e2e2e',
      '--surface-container-strong': '#343434',
      ...
      '--selection-bg': 'rgba(44,107,237,0.28)',
      '--logo-type': 'classic',
      '--settings-bg': '#1b1b1b',
      '--settings-surface': '#262626',
      '--settings-surface-var': '#2e2e2e',
      '--settings-outline': '#343434',
      '--settings-outline-med': '#3b3b3b',
      '--settings-on-surface': '#f6f6f6',
      '--settings-on-surface-var': '#848484',
      '--settings-primary': '#2c6bed',
      '--settings-on-primary': '#ffffff',
      '--settings-primary-cont': '#1a3b80',
  ...
  light: {
    ...
    vars: {
      ...
      '--accent-light': '#548bf5',
      '--accent-dark': '#1f4bb6',
      '--accent-glow': 'rgba(44,107,237,0.16)',
      '--accent-glow-light': 'rgba(44,107,237,0.08)',
      '--text-main': '#1b1b1b',
      '--text-dim': '#5e5e5e',
      '--text-offline': '#848484',
      '--text-heading': '#121212',
      '--surface-container': '#f0f0f0',
      '--surface-container-strong': '#e9e9e9',
      ...
      '--selection-bg': 'rgba(44,107,237,0.16)',
      '--logo-type': 'classic',
      '--settings-bg': '#f6f6f6',
      '--settings-surface': '#ffffff',
      '--settings-surface-var': '#f0f0f0',
      '--settings-outline': '#dedede',
      '--settings-outline-med': '#c6c6c6',
      '--settings-on-surface': '#1b1b1b',
      '--settings-on-surface-var': '#5e5e5e',
      '--settings-primary': '#2c6bed',
      '--settings-on-primary': '#ffffff',
