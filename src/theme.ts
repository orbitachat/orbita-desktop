...
export const themePalettes: Record<ThemeId, ThemeDefinition> = {
  system: {
    ...
    vars: {
      ...
      '--text-offline': '#6b6d76',
      '--text-heading': '#ffffff',
      '--surface-container': '#2c2d33',
      '--surface-container-strong': '#35373e',
      ...
      '--logo-type': 'classic',
      '--settings-bg': '#222327',
      '--settings-surface': '#2c2d33',
      '--settings-surface-var': '#35373e',
      '--settings-outline': '#32333a',
      '--settings-outline-med': '#3b3d46',
      '--settings-on-surface': '#f6f6f6',
      '--settings-on-surface-var': '#8e9099',
