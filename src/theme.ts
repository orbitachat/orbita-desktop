...
export const themePalettes: Record<ThemeId, ThemeDefinition> = {
  system: {
    ...
    vars: {
      ...
      '--text-offline': '#757882',
      '--text-heading': '#ffffff',
      '--surface-container': '#33363f',
      '--surface-container-strong': '#3d414c',
      '--surface-container-soft': 'rgba(255,255,255,0.06)',
      '--surface-muted': 'rgba(255,255,255,0.09)',
      '--surface-muted-strong': 'rgba(255,255,255,0.16)',
      '--surface-subtle': 'rgba(255,255,255,0.04)',
      '--border-color': '#373a43',
      '--surface-border': '#33363f',
      '--online-color': '#4caf50',
      ...
      '--logo-type': 'classic',
      '--settings-bg': '#2a2c33',
      '--settings-surface': '#33363f',
      '--settings-surface-var': '#3d414c',
      '--settings-outline': '#373a43',
      '--settings-outline-med': '#424550',
      '--settings-on-surface': '#f6f6f6',
      '--settings-on-surface-var': '#9ea1ab',
