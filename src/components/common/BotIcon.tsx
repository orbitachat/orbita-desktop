...
export const BotIcon: React.FC<{ size?: number; className?: string; style?: React.CSSProperties; color?: string }> = ({
  size = 15,
  className = '',
  style = {},
  color = 'currentColor',
