...
import { htmlToMarkdown, markdownToHtml } from '../../utils/messageUtils';
              ...
              <div
                ...
                dangerouslySetInnerHTML={{
                  __html: markdownToHtml(
                    (editingIndex !== null ? (editingOriginalText || editText) : (replyingTo?.text || '')).replace(/\n+/g, ' ')
                  ).replace(/<br\s*\/?>/gi, ' '),
                }}
              />
            </div>
