...
import { parseReplyChain, countEmojis, formatTimeOfDay, markdownToHtml } from '../../utils/messageUtils';
...
export const MessageItem: React.FC<MessageItemProps> = React.memo(
  ({ msg, isOwn, isPinned, onContextMenu, themeColor, bubbleRadius, currentUserId, onToggleReaction, onQuoteClick, isGroup = false, onLinkClick }) => {
    ...
    // Без пузыря отображаются только 1, 2 и 3 эмодзи
                  ...
                  >
                    <div className="flex-1 min-w-0">
                      ...
                      <p
                        ...
                        dangerouslySetInnerHTML={{ __html: markdownToHtml(q.text, themeColor).replace(/<br\s*\/?>/gi, ' ') }}
                      />
                    </div>
                  </div>
                ))}
